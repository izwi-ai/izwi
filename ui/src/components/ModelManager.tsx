...
> = {
  ...
  "Qwen3-0.6B-GGUF": {
    ...
    features: ["Text generation", "GGUF", "Q8_0 quantized"],
    size: "1.0 GB",
    quantization: "Q8_0",
  },
  "Qwen3-1.7B-GGUF": {
  ...
  "Qwen3-4B-GGUF": {
    ...
    description:
      "Qwen3 4B model in GGUF Q4_K_M format",
    features: ["Text generation", "GGUF", "Q4_K_M quantized"],
    size: "2.5 GB",
    quantization: "Q4_K_M",
  },
  "Qwen3-8B-GGUF": {
    ...
    description:
      "Qwen3 8B model in GGUF Q4_K_M format",
    features: ["Text generation", "GGUF", "Q4_K_M quantized"],
    size: "5.2 GB",
    quantization: "Q4_K_M",
  },
