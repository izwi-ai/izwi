...
impl KVCacheManager {
    ...
    pub fn stats(&self) -> KVCacheStats {
        ...
        KVCacheStats {
            ...
            block_memory_bytes: self.config.block_memory_bytes(),
    ...
    pub fn stats(&self) -> StreamingKVCacheStats {
        StreamingKVCacheStats {
            base_stats: KVCacheStats {
                ...
                allocated_blocks: self.allocator.num_allocated(),
                free_blocks: self.allocator.num_free(),
                block_size: self.config.base_config.block_size,
                dtype_bytes: self.config.base_config.dtype_bytes,
                block_memory_bytes: self.config.base_config.block_memory_bytes(),
